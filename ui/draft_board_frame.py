...
class DraftBoardFrame(tk.Frame):
    def __init__(self, parent, controller, my_draft, my_db_table, my_csv_file, my_teams):
        ...
        self.recommendations_tree.column('Recommended', anchor='center', width=160)
        self.recommendations_tree.column('Next Pick', anchor='center', width=160)
        self.recommendations_tree.column('Two Picks', anchor='center', width=160)
        ...
        for i, (label, command) in enumerate(filter_buttons):
            btn = tk.Button(self.player_filters_frame, text=label, command=command)
